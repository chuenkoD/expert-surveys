...
## Висновки
Google Forms є найбільш зручним сервісом з переліку, проте порівняно з іншими системами з вибірки, йому не вистачає функціональності. Сервіси SurveyJS та ОСА мають ширший функціонал, проте мають більш складний та незрозумілий інтерфейс, що може злякати нового користувача. Survio та SurveyMonkey, в свою чергу, потребують передплату на їхні сервіси, що виливается у значні фінансові витрати.
